...
It is assumed that you can access the class via zoom and have a functioning web browser that can access your  @pdx.edu account.  The slides are interactive and assume you have some kind of touch or pseudo-pen interface. You could use your finger and your phone (which works but I would not recommend), a computer with a touch screen, or even a small \$30 Wacom tablet.

The technology requirements are your responsibility. 

# Contact Information

Communication will be handled through slack <http://woodseconomics.slack.com/>. There is an invite link on the Canvas homepage for this course. Use your @pdx.edu email to sign up. There are reasonable help documents to get you started (<https://get.slack.help/hc/en-us/articles/218080037-Getting-started-for-new-users>)

Slack will be used for IM, email and forum style communication. It even handles phone and video calls. If you have a question about course material or the course itself, ask in one of the channels, e.g., \#micro_general. If you have a personal message that is not intended for others, send a direct message, i.e., @woodsj.

Office Hours:

Office hours, where I or the GA, Roy, will be active on Slack to answer questions via text, voice, or video, are scattered in the attempt to make at least one convenient for you.   I will respond on Slack at other times, but I will not respond immediately.
...
This class is remote, which means it is just like regular class.  We talk. Ask questions.  Draw things on the whiteboard/jamboard.

## Regular Lecture Days

I'll have zoom up, but I'll just have the microphone on. The the in-class material will be a combination of Google slides, which I will share with you and a jamboard for problem solving. This should work a lot better for those with with slower computer processors and less memory. Zoom video eats cpu cycles.  
...
There is a participation component to this.  We will actually put your **anonymous** work up for others to see.  We will also look at how well you did on those in-class exercises, either getting things generally right or showing some progress towards doing well. This will show up in the grade book as a quick assessment:

+ 0: Absent, not or minimally active.
...
There are no actual `points` for this but your participation determines the standard that we use on the modules, described next, for determining if you pass at an acceptable level.  Active students don't need to show as much on the Achieve quizzes because they have shown it in class.  The others needs to score higher on the modules in Achieve.
...
Quizzes for each module are available now.  You can start if you like.  The due dates are generally about three weeks after we introduce the topic in class. There will be an `LearningCurve` quiz, which can take anywhere from 15 minutes to forever.  You only get one try at these so reserve some time.  The grade on these are all or nothing.  Not passing means you need to do much better on the other quiz elements.

The other quizzes, which are a combination of video questions, multiple choice and graphing can be completed at most five times and you have an hour to complete them.  We take the high score. 

There are at least three of these other exercises in each chapter. All of these are in the Modules you can find in Achieve when you choose to view by `Course Content`.
...
Nothing I do will will help you learn unless you believe that you can learn and that you want to learn.  Trying to teach an unmotivated learner, or someone that thinks they can't learn is an impossible task.

For many of you the hardest module is the first one that covers the math you need for the course. You only need Freshman High School Algebra.  The textbook has a summary but if you need more, work through Khan Academy (https://www.khanacademy.org/math) and get where you have to go.

The second thing I need you to do is read. It is the fastest way to learn.  Lecture is far more limited in scope and detail and lecture slides are summaries of summaries. Each of those summaries built for someone other than you.

A better approach to reading the mass of material you need to read in you courses, and to keep current in your field, is **academic skimming**.  Just Google it and follow the directions.  Your future self will thank you.

# Textbook and Other Resources

I have assigned Krugman, Paul R., and Robin Wells. Microeconomics ed. 6., Worth Publishers. The text is bundled with quizzes and homework assignments and you should be able to purchase the whole package through https://achieve.macmillanlearning.com/courses/asmeup

## Topics

Some of the shorter chapters will be combined into one module.
...
1. Decision Making by Individuals and Firms (Ch 9):  Different ways of thinking about costs and which ones are important, plus a few things about time value of money.

1. The Rational Consumer (Ch 10): This is the idealized case and explains huge chunks of human behavior.  There is a little bit about behavioral economics.
...
1. Oligopoly (Ch 14):  Somewhere between Monopoly and Perfect Competion.
