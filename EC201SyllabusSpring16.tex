...
If you can't attend regular office hours, please check my calendar link \url{http://NEED}. I will make a limited number of 15 minute slots available each week. Appointments after 5pm will be via google hangout only. \emph{If you make an appointment and fail to show up without first canceling, I will penalize you one quiz grade.}  
