...
This will be a very unusual term.  While this is listed as an in-person class, we will not be meeting in a classroom.  We will be meeting online via Google Meet at the usual course time.  Should Google Meet fail us, we will switch to Zoom. If that fails, I will sort something out until we are left standing in a circle, in a field, separated from each other by at least three meters, where we will discuss microeconomics and barter for toilet paper.
...
As of today, I am unclear how DRC accomodations will be managed, or if we will be meeting in-person at all this term.
...
Exams will be given on those days and at those times only.  They will be implemented as a quiz in D2L, open only for the 1:50 of class time and subject to proctoring.  The final is required.  
...
You will only be allowed 4 missing class session quizzes before I stop giving you credit for work. This is enough leeway to allow you to have an short illness or transportation difficulty, but not enough to allow you to sabotage your education.

+ If you miss five quizzes, please drop the class.
+ If you have an extended illness or other difficulty that makes it very difficult to join the class online, file a deadline appeal to have the course removed from your record and get your tuition returned. 
