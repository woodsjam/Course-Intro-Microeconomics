...
+ Midterm 2 (20%)
+ In-class quizzes (20%)
    + Math Pre-Test,  First Day of Class Only
    + Micro Post-Test,  Last Day of Class Only
+ Homework (10%)

The pre and post test are new this term. The two pre and post are for course, rather than student, evaluation purposes and will be open response rather than multiple choice.
