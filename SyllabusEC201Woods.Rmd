...
+ Each module quiz will be available during the the Wednesday course period only. If your module quiz score is above a certain level -- you have completed the module.
    ...
    + One-on-one meeting can be scheduled through https://woodsj.youcanbook.me/
...
If you don't pass the module's homework and quiz the week the topic is introduced, you can take it the next week but there will also be a new module(s) with its own homework assignment and quiz to complete too.  In fact, if you don't pass it twice you can still redo the work in the third week.
...
You must must schedule the one-on-one meeting within two weeks of the quiz or you will not recieve credit for the module.
...
There will be an  homework assignment available for each of the last three modules due that Friday at 11:59 PM.  If you have not completed these modules, i.e., passed the homeowkr and quiz, you can complete these homework assignments. 
...
+ Q: I passed the quiz on the third attempt but did not schedule a one-on-one meeting to discuss answers.  What happens? A: Again, this you did not pass the module.
...
Your grade in the class is determined by the number of modules you acceptably complete.  To acceptably complete a module you must turn in an acceptable homework assignment and complete a quiz at an acceptable level.  Furthermore, if you pass the quiz on the last possible date, you must meet one-on-one with me to discuss your answers and give acceptable responses.
...
PSU's policy on how P/NP grades will be used during the COVID-19 pandemic is in flux.  We are currently learning a term at a time how they will be used.  For Fall term P/NP grades would count as letter grades for satisfying major and degree requirements.  
